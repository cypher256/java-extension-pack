...
### Check Version
Select the Java version from the dropdown in the VS Code terminal and execute the following commands. The terminal Java dropdown items are automatically created by this extension ([Java 21 support](https://github.com/redhat-developer/vscode-java/issues?q=is%3Aissue+%22JavaSE-21%22)). The latest versions of gradle and mvn are available, but wrappers (gradlew, mvnw) are recommended.
```bash
java -version
gradle -v
mvn -v
