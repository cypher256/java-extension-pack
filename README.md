...
The downloaded JDKs are stored in the following JDK Auto extension global storage directory (*3).
...
The `Extension Pack for Java` is required. Other unused extensions [can be uninstalled](https://code.visualstudio.com/docs/editor/extension-marketplace#:~:text=you%20can%20always-,Uninstall,-the%20extension%20from).
